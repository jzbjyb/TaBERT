...
input_dir=/mnt/root/tapas/data/pretrain/train/preprocessed_mention_samepage_hardmatch_withcells_cleaned_bartlarge_bs20_bidirectionchosen.incomplete.jsonl.data0
output_dir=/mnt/root/TaBERT/data/train_data/wholetable_tapas_data0_bart_samepage_hardmatch_data2text_cleaned_bartlarge_bs20_bidirectionchosen_incomplete
