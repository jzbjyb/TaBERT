output_dir=/mnt/root/TaBERT/data/train_data/wholetable_wikisent_tapas_500k_bart_mlm_contextmention
input_dir=/mnt/root/TaBERT/data/wikipedia_sent/preprocessed_tapas_retbycontext_500k.jsonl
