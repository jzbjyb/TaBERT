output_dir=/mnt/root/TaBERT/data/train_data/wholetable_3merge_bert_mlm_mc
input_dir=/mnt/root/TaBERT/data/grappa/totto_tablefact_wikisql_train_preprocessed_mention_cell.jsonl
