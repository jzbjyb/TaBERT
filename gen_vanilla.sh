output_dir=/mnt/root/TaBERT/data/train_data/wholetable_tapas_bert_mlm_data0
input_dir=/mnt/root/tapas/data/pretrain/train/preprocessed_mention.jsonl.data0.ner
