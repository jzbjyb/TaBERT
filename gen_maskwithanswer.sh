...
output_dir=/mnt/root/TaBERT/data/train_data/wholetable_3merge_bart_bartmask_salientmask_mentioncontext

# -- TAPAS data --
#input_dir=/mnt/root/tapas/data/pretrain/train/preprocessed_mention_samepage_hardmatch_topk3.jsonl.data0
#output_dir=/mnt/root/TaBERT/data/train_data/wholetable_tapas_data0_bart_samepage_hardmatch_topk3_bartmask_mentioncontext
...
for (( i=0; i<${worldsize}; ++i)); do
  ...
  python -m utils.generate_vanilla_tabert_training_data \
    ...
    --seq2seq_format bart-mask_mention-context \
